...
class imprimirReporteDestinatario {
    public function traerReporteDestinatario() {
        ...
        $pdf->SetTitle('Reporte de Destinatarios');
        $pdf->SetSubject('Reporte de Destinatarios');
        $pdf->SetKeywords('TCPDF, PDF, reporte, destinatarios');
...
EOF;
        ...
        // Bloque 4: Datos de los destinatarios
        $item = null;
        $valor = null;
...
$reporte = new imprimirReporteDestinatario();
$reporte->traerReporteDestinatario();
