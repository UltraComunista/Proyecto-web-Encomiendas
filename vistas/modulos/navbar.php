            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="registrarenv" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Registrar envios</span>
                    </a>
                  </li>
                  <li class="sidebar-item">
                    <a href="listaenvios" class="sidebar-link">
                      ...
                      <span class="hide-menu">Lista envios</span>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item">
                <a class="sidebar-link" href="remitente" aria-expanded="false">
                  <span>
                    <i class="ti ti-package-export"></i>
                  </span>
                  <span class="hide-menu">Remitentes</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a class="sidebar-link" href="destinatario" aria-expanded="false">
                  <span>
                    <i class="ti ti-map-pins"></i>
                  </span>
                  <span class="hide-menu">Destinatario</span>
                </a>
              </li>
              <li class="sidebar-item">
